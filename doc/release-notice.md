...
### Updates in 1.111 Build 4

Respond with a NAK if an out of place osdp_SCRYPT is received.
...
Add monitor display logic to show osdp_ID block parameter.
...
### Updates in 1.101 Build 3 ###

Correct false positive LED report in NAK processing.
