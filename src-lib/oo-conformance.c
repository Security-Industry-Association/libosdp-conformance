...
OSDP_CONFORMANCE_TEST
  test_control [] =
  {
    ...
    {         OOC_SYMBOL_cmd_led_blue,
      ...
      0, 0, 0, 0, 0,
                        "Command: LED(Blue)"},
    {         OOC_SYMBOL_cmd_led_cyan,
      &(osdp_conformance.cmd_led_cyan.test_status),
      0, 0, 0, 0, 0,
                        "Command: LED(Cyan)"},
    {         OOC_SYMBOL_cmd_led_green,
      ...
      0, 0, 0, 0, 0,
                        "Command: LED(Green)"},
    {         OOC_SYMBOL_cmd_led_magenta,
      &(osdp_conformance.cmd_led_magenta.test_status),
      0, 0, 0, 0, 0,
                        "Command: LED(Magenta)"},
    {         OOC_SYMBOL_cmd_led_red,
      ...
      0, 0, 0, 0, 0,
                        "Command: LED(Red)"},
    {         OOC_SYMBOL_cmd_led_white,
      &(osdp_conformance.cmd_led_white.test_status),
      0, 0, 0, 0, 0,
                        "Command: LED(White)"},
    ...
    {         OOC_SYMBOL_cmd_poll,
      ...
      1, 0, 0, 0, 0,
                        "Command: POLL"},
    {         OOC_SYMBOL_cmd_rstat,
      &(osdp_conformance.cmd_rstat.test_status),
      1, 0, 0, 0, 0,
                        "Command: RSTAT"},
    {         OOC_SYMBOL_cmd_text,
      &(osdp_conformance.cmd_text.test_status),
      1, 0, 0, 0, 0,
                        "Command: TEXT"},
    {         OOC_SYMBOL_multibyte_data_encoding,
    ...
    {         OOC_SYMBOL_physical_interface,
      ...
      1, 0, 0, 0, 0,
                        "physical interface"},
    {         OOC_SYMBOL_poll_lstatr,
      &(osdp_conformance.poll_lstatr.test_status),
      0, 0, 0, 0, 0,
                        "LSTATR to Poll"},
    {         OOC_SYMBOL_rep_ack,
      ...
      1, 1, 1, 1, 0,
                        "Response: ACK" },
    {         OOC_SYMBOL_resp_biomatchr,
      &(osdp_conformance.resp_biomatchr.test_status),
      1, 1, 1, 1, 0,
                        "Response: BIOMATCHR"},
    ...
    {         OOC_SYMBOL_rep_device_ident,
      ...
      1, 1, 1, 1, 0,
                        "rep_device_ident"},
    {         OOC_SYMBOL_resp_cap_card_fmt,
      &(osdp_conformance.resp_cap_card_fmt.test_status),
      1, 1, 1, 1, 0,
                        "CAP: Card Fmt" },
    ...
    {         OOC_SYMBOL_resp_ostatr,
      ...
      1, 1, 1, 1, 0,
                        "Response: OSTATR"},
    {         OOC_SYMBOL_resp_ostatr_ack,
      &(osdp_conformance.resp_ostatr_ack.test_status),
      1, 1, 1, 1, 0,
                        "OSTATR after ACK"},
    {         OOC_SYMBOL_resp_rstatr,
      &(osdp_conformance.resp_rstatr.test_status),
      1, 1, 1, 1, 0,
                        "Response: RSTATR"},
    ...
    {         OOC_SYMBOL_CRC,
      ...
      1, 0, 0, 0, 0,
                        "CRC"},
    {         OOC_SYMBOL_CRC_bad_response,
      &(osdp_conformance.CRC_bad_response.test_status),
      1, 0, 0, 0, 0,
                        "CRC bad response"},
    {         OOC_SYMBOL_CRC_bad_command,
      &(osdp_conformance.CRC_bad_command.test_status),
      1, 0, 0, 0, 0,
                        "CRC bad command"},
    {         OOC_SYMBOL_checksum,
    ...
    {         OOC_SYMBOL_cmd_mfg,
      ...
      0, 0, 0, 0, 0,
                        "Command: osdp_MFG"},
    {         OOC_SYMBOL_cmd_pivdata,
      &(osdp_conformance.cmd_pivdata.test_status),
      0, 0, 0, 0, 0,
                        "Command: osdp_PIVDATA"},
    ...
    {         OOC_SYMBOL_resp_busy,
      ...
      0, 0, 0, 0, 0,
                        "Response: osdp_BUSY"},
    { OOC_SYMBOL_resp_ccrypt, &(osdp_conformance.resp_ccrypt.test_status),
      0, 0, 0, 0, 0, "Response: osdp_CCRYPT" },
    { OOC_SYMBOL_resp_rmac_i, &(osdp_conformance.resp_rmac_i.test_status),
...
"3-1-2  Poll raw                           %s",
  ...
  LOG_REPORT ((log_string,
"3-1-3  Poll lstatr                        %s",
    conformance_status (oconf->poll_lstatr.test_status)));
  LOG_REPORT ((log_string,
...
"4-6-1  Input Status Report                %s",
    conformance_status (oconf->resp_istatr.test_status)));
  LOG_REPORT ((log_string,
